package andoid.hamzaig.toptendownlaoder;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class DownloadingData extends AsyncTask<String,Void,String>{
        private static final String TAG = "DownloadingData";
        @Override
